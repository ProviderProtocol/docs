...
[@providerprotocol/ai](../../../modules.md) / [@providerprotocol/ai](../README.md) / createProvider

# Function: createProvider()

> **createProvider**\<`TOptions`\>(`options`): [`Provider`](../interfaces/Provider.md)\<`TOptions`\>

Defined in: [src/core/provider.ts:85](https://github.com/ProviderProtocol/ai/blob/1371aa52f0fff5bd5bfdb45a7fdb59d2ae80d714/src/core/provider.ts#L85)
