...
[@providerprotocol/ai](../../modules.md) / [http](../README.md) / parseSSEStream

# Function: parseSSEStream()

> **parseSSEStream**(`body`): `AsyncGenerator`\<`unknown`, `void`, `unknown`\>

Defined in: [src/http/sse.ts:37](https://github.com/ProviderProtocol/ai/blob/1371aa52f0fff5bd5bfdb45a7fdb59d2ae80d714/src/http/sse.ts#L37)
