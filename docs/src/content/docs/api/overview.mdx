...
This section documents the public API of the `@providerprotocol/ai` library, the reference implementation of the [UPP-1.1 Specification](/spec/overview).
...
<Aside type="note" title="Specification">
  This library implements the [UPP-1.1 Specification](/spec/overview).
