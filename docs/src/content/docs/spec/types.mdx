...
| `BeforeCallResult` | Return type for `onBeforeCall` hook with param transformation |
| `AfterCallResult` | Return type for `onAfterCall` hook with result transformation |
