...
[@providerprotocol/agents](../../modules.md) / [index](../README.md) / hasToolDependencies

# Function: hasToolDependencies()

> **hasToolDependencies**(`tools`): `boolean`

Defined in: [src/execution/tool-ordering.ts:233](https://github.com/ProviderProtocol/agents/blob/6c552a1ce44c20ba911004f801fa7e4bc6c72033/src/execution/tool-ordering.ts#L233)
