...
- Learn about [Design Principles](/spec/design-principles/)
- Understand the [Architecture](/spec/architecture/)
- Explore [Tools and Function Calling](/spec/llm/tools/)
- Read about [Structured Outputs](/spec/llm/structured/)
- See the full [API Reference](/api/overview/)
