...
<Aside type="tip">
If you access `stream.turn` without iterating the stream first, it will automatically drain the stream for you. This is useful when you only care about the final result.
</Aside>
